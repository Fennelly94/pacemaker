...
/**
 * 
 * @author Gavin Fennelly version: 27/10/2015
 * 
 *         This class will provide the menu system of this programme. It allows
 *         the user to select an image from the list and what they would like to
 *         do with it and then asks if they would like to continue using the
 *         program.
 *
 */
...
public class Driver {
	/**
	 * The main function of this class is getting the user to select an image
	 * and asks the user what operation they want to perform on the image.
	 */
	...
	/**
	 * 
	 * Provides the menu system so the user can choose which image he wants to
	...
	public String mainMenu() {
		...
		switch (option) {
		case 1:
			choice = "images/ballons.png";
			break;
		case 2:
			choice = "images/faces.jpg";
			break;
		case 3:
			choice = "images/shapes.jpg";
			break;
		case 4:
			choice = "images/stars.png";
			break;
		case 5:
			choice = "images/stones.jpg";
		}
		return choice;
	}
	...
	/**
	 * 
	 * Allows the user to choose an operation to perform on their selected
	 * image.
	 */

	public void chooseAction(String fileLocation) {
		ConnectedComponentImage image = new ConnectedComponentImage(
				fileLocation);
		...
		switch (option) {
		case 1:
			StdOut.println(image.countComponents());
			break;
		case 2:
			Picture picture = image.binaryComponentImage();
			picture.show();
			break;
		case 3:
			int picture1 = image.colourComponentImage();

			break;
		case 4:
			Picture picture2 = image.identifyComponentImage();
			picture2.show();
			break;
		case 5:
			String picSize = image.sizeOfPic();
			StdOut.println(picSize);
			break;
		case 6:
			Picture picture3 = image.Greyscale();
			picture3.show();
			break;
		case 7:
			int area = image.getAmountOfPixels();
			StdOut.println("There is " + area + " pixels in this image.");
			break;
		case 8:
			picture = image.origionalImage();
			break;
		}
	}
